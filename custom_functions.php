...
register_sidebar(
	array(
		'name' => __("Above Header", "my-underscores-theme"),
		'id' => 'aboveheader',
...
register_sidebar(
	array(
		'name' => __("Above Content Area", "my-underscores-theme"),
		'id' => 'abovecontent',
...
register_sidebar(
	array(
		'name' => __("Footer Content", "my-underscores-theme"),
		'id' => 'footercontent',
		'description' => 'Footer only, left aligned',
